...
class PPLiteSeg(nn.Layer):
    ...
    # UAFM_SpAtten   UAFM_CMFAtten   UAFM_CMFAttenV02
    def __init__(self,
                 num_classes,
                 backbone,
                 backbone_indices=[2, 3, 4],
                 arm_type='UAFM_CMFAttenV01',
                 cm_bin_sizes=[1, 2, 4],
                 cm_out_ch=128,
    ...
    def forward(self, x):
        ...
        # backbone's character map/ x2,x4,x8,x16,x32 
        ...
        # 特征头部分
        # Their is give the feature maps into the self.ppseg_hed，then can get the feas_head
...
class PPLiteSegHead(nn.Layer):
    ...
    def __init__(self, backbone_out_chs, arm_out_chs, cm_bin_sizes, cm_out_ch,
        ...
        # There is the main PP-liteseg
        # and we can get the feature map from the PPContextModule
